...
<body>
    ...
    <i class="fas fa-clipboard-list fa-fw"></i> &nbsp;LISTA DE PEDIDOS PENDIENTES</h3> 
...
<td>
	<a type="submit" href="{{ route('lisPedidosP', [$item->id_carrito]) }}"><i class="fas fa-shopping-cart" style="color: red;"></i> </a>
</td>

	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Nueva Comunidad <small>COMMCRAFT</small></h1>
			</div>
			<p class="lead">Las comunidades de Bolivia reflejan la diversidad cultural del país, preservando tradiciones, conocimientos ancestrales y expresiones artísticas únicas de cada región.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
										<form action="{{ route('comunidads.store') }}" method="POST">
											@csrf
											<div class="form-group label-floating">
											  <label class="control-label">Nombre</label>
											  <input class="form-control" type="text" id="nombreCo" name="nombreCo" required>
											</div>
											<div class="form-group label-floating">
											...
											<div class="form-group label-floating">
											  ...
											  <input class="form-control" type="text" id="ubicacionC" name="ubicacionC" required>
											</div>
										    <p class="text-center">
										    	<button type="submit" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Guardar Comunidad</button>
										    </p>
									    </form>
									</div>
								</div>

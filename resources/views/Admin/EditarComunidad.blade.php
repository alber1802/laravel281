	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Editar Comunidad <small>COMMCRAFT</small></h1>
			</div>
			<p class="lead">Editar una comunidad permite actualizar su información y características, reflejando con precisión su identidad cultural y fortaleciendo su presencia en el sistema.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
                                        <form action="{{ route('administracion.comunidads.update', $comunidad->id_comunidad) }}" method="POST">
                                            @csrf
                                            @method('PUT')

									    	<div class="form-group label-floating">
											  <label for="nombreCo" class="control-label">Nombre</label>
                                              <input type="text" class="form-control" id="nombreCo" name="nombreCo" value="{{ $comunidad->nombreCo }}" required>
											</div>
											<div class="form-group label-floating">
											  <label for="ciudad" class="control-label">Ciudad </label>
											  <input type="text" class="form-control" id="ciudad" name="ciudad" value="{{ $comunidad->ciudad }}" required>
											</div>
                                            <div class="form-group label-floating">
											  <label for="ubicacionC" class="control-label">Ubicacion </label>
											  <input type="text" class="form-control" id="ubicacionC" name="ubicacionC" value="{{ $comunidad->ubicacionC }}" required>
											</div>
										    <p class="text-center">
										    	<button type="submit" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Actualizar Comunidad</button>
										    </p>
									    </form>
									</div>
								</div>

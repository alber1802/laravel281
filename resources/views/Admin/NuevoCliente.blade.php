	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Nuevo Cliente <small>COMMCRAFT</small></h1>
			</div>
			<p class="lead">Agregar un nuevo cliente permite registrar su información en el sistema, facilitando su acceso a productos y servicios personalizados.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12"> 
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
										<form name="registro" action="{{ route('validarRegistro') }}" method="POST" enctype="multipart/form-data" >
											@csrf
											...
											<div class="form-group label-floating">
											  <select class="control-label" id="sexo" name="sexo" required class="input">
										    ...
										    <p class="text-center">
										    	<button type="submit" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Guardar Cliente</button>
										    </p>
									    </form>
									</div>
								</div>

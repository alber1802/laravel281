	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Nueva Categoria <small>COMMCRAFT</small></h1>
			</div>
			<p class="lead">Las categorías de productos artesanales agrupan artículos por tipo y material, facilitando 
				que los clientes encuentren piezas según sus intereses y destacando la diversidad cultural.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
										<form action="{{ route('categorias.store') }}" method="POST">
											...
											<div class="form-group label-floating">
											  ...
											  <input class="form-control" type="text" id="nombreCa" name="nombreCa" required>
											</div>
											<div class="form-group label-floating">
											  <label class="control-label">Descripcion</label>
											  <input class="form-control" type="text" id="descripcionCa" name="descripcionCa" required>
											</div>
										    <p class="text-center">
										    	<button type="submit" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Guardar Categoria</button>
										    </p>
									    </form>
									</div>
								</div>

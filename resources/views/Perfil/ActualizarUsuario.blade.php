...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/Perfil/ActualizarUsuario.css')}}">
</head>
<body>
<div class="container">
  <div class="heading">Actualizar Perfil </div>
  <form class="form" id="profile-form" action="{{route('ActualizarPerfil')}}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <input placeholder="Preferencias" id="preferencia" name="preferencia" type="text" class="input" />
